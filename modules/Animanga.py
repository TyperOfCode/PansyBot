...
class AnimeForm(commands.Cog):
    def __init__(self, bot):
        ...
        self.animanga_channel_id = 694030910936317982
    ...
    async def on_message(self, message):
        ...
        if self.completed_role in message.author.roles or self.users:
            return
        ...
        try:
            ...
            try:
                ...
                await message.channel.send("Unexpected Error Occurred. Please retry")
                return

        self.users[message.author.id] = {"Colour": colour, "Question": 0, "Roles": [], "Anime_Q": {}, "Manga": {},
                                         "LightNovel": {}, "Animanga": {}, "Characters": {}}
        ...
        ping = await self.form_entry_channel.send(message.author.mention)
        try:
            await ping.delete()
        except:
            pass
        ...
        start_msg = f"""Hello, {message.author.mention} would you like to take our Animanga survey?
                    ...
                    Survey Details:
                    You may type `skip` on question after question 2, or press â›”
        ...
        if self.Anime_Q:
            ...
            anime_description = f"""
            <a:malHeartDose:613541345021263881> <a:mal_AA:667431391918555174> <a:mal_NN:667432127893209098> <a:mal_II:667431773659201578> <a:mal_MM:667432082603114497> <a:mal_EE:667431579530035200> <a:malHeartDose:613541345021263881>
            {"".join(templist)}"""
        ...
        if self.Manga:
            ...
            manga_description = f"""
            <a:malHeartDose:613541345021263881> <a:mal_MM:667432082603114497> <a:mal_AA:667431391918555174> <a:mal_NN:667432127893209098> <a:mal_GG:667431704868290578> <a:mal_AA:667431391918555174>  <a:malHeartDose:613541345021263881>
            {"".join(templist)}"""
        ...
        if self.Animanga:
            ...
            animanga_description = f"""
            <a:malHeartDose:613541345021263881><a:mal_AA:667431391918555174><a:mal_NN:667432127893209098><a:mal_II:667431773659201578> <a:mal_MM:667432082603114497> <a:mal_AA:667431391918555174> <a:mal_NN:667432127893209098> <a:mal_GG:667431704868290578> <a:mal_AA:667431391918555174>  <a:malHeartDose:613541345021263881>
            {"".join(templist)}"""
        ...
        link = await self.request_message(message.author,
        ...
        await self.send_webhook(self.favorites_channel, message.author, embeds)

        done = discord.Embed(title=f"{message.author.name} Just completed their Animanga Survey!",
                             description="Send `h^animanga` in <#622906588562456576> to start!", colour=0xa9a9a9)
    ...
    async def Anime_Qs(self, message):
        ...
        anime_ans_2 = await self.request_message(message.author, "List upto 5 titles of your favorite anime.",
                                                 "Please seperate your titles with ,")
        ...
        anime_ans_5 = await self.request_message(message.author, "What Anime World do you wish to live in?",
                                                 "You may type `skip`")
        ...
        anime_ans_6 = await self.request_message(message.author, "What's your favorite Anime Studio?",
                                                 "You may type `skip`")
        ...
        anime_ans_7 = await self.request_message(message.author,
                                                 "Write the title of an anime that you think is __overrated.__",
                                                 "You may type `skip`")
        ...
        anime_ans_8 = await self.request_message(message.author,
                                                 "Write the title of an anime that you think is __underrated.__",
                                                 "You may type `skip`")
        ...
        anime_ans_9 = await self.request_message(message.author, "Which Anime __Opening__ theme is your favorite?",
                                                 "You may type `skip`")
        ...
        anime_ans_10 = await self.request_message(message.author, "Which Anime __Ending__ theme is your favorite?",
                                                  "You may type `skip`")
    ...
    async def Manga_Qs(self, message):
        ...
        manga_ans_2 = await self.request_message(message.author, "List up to five titles of your favorite Manga!",
                                                 "Please seperate your titles with ,")
        ...
        manga_ans_4 = await self.request_message(message.author, "What's the weirdest Manga you've read?",
                                                 "You may type `skip`")
        ...
        manga_ans_5 = await self.request_message(message.author,
                                                 "Write the title of a manga that you think is __Overrated__.",
                                                 "You may type `skip`")
        ...
        manga_ans_6 = await self.request_message(message.author,
                                                 "Write the title of a manga that you think is __Underrated__.",
                                                 "You may type `skip`")
    ...
    async def LightNovel_Qs(self, message):
        ...
        light_ans_2 = await self.request_message(message.author,
                                                 "List up to three titles of your favorite Lightnovels!",
                                                 "Please seperate your titles with ,")
    ...
    async def Animanga_Qs(self, message):
        ...
        animanga_ans_2 = await self.request_message(message.author, "What's your favorite Anime Movie?",
                                                    "Please seperate your titles with ,")

        if animanga_ans_2:
            self.Animanga['Favorite Anime Movie'] = animanga_ans_2

        # ------------- Q3

        animanga_ans_3 = await self.request_message(message.author, "What's your favorite Anime Episode?",
                                                    "Examples: Re Zero Episode 15, Haikyuu S3 Episode 4")

        if animanga_ans_3:
            self.Animanga['Favorite Anime Episode'] = animanga_ans_3

        # ------------- Q4

        animanga_ans_4 = await self.request_message(message.author, "What's your favorite Anime Season?",
                                                    "Examples: Winter 2019, Spring 2011")
        ...
        animanga_ans_5 = await self.request_message(message.author, "What's your favorite Manga Volume?",
                                                    "Examples: Shingeki no Kyojin Volume 20, Slam Dunk Volume 31")
        ...
        animanga_ans_6 = await self.request_message(message.author,
                                                    "When was the first time you watched your first anime on the internet?",
                                                    "Format DD/MM/YY or MM/YY")
    ...
    async def Characters_Qs(self, message):
        ...
        char_ans_1 = await self.request_message(message.author, "Who's your favorite Male Protagonist?",
                                                "You may type `skip`")
        ...
        char_ans_2 = await self.request_message(message.author, "Who's your favorite Female Protagonist?",
                                                "You may type `skip`")
        ...
        char_ans_3 = await self.request_message(message.author, "Who's your favorite Male Antagonist?",
                                                "You may type `skip`")
        ...
        char_ans_4 = await self.request_message(message.author, "Who's your favorite Female Antagonist?",
                                                "You may type `skip`")
        ...
        char_ans_5 = await self.request_message(message.author, "Who's your favorite Couple?",
                                                "For example, Naruto x Hinata, Kousei x Kaori")
        ...
        char_ans_6 = await self.request_message(message.author, "What's your favorite Anime pet?",
                                                "For example, Happy from Fairy tail, Sadaharu from Gintama")
    ...
    async def request_emote(self, author: discord.User, message, footer, emotes: dict):
        ...
        message = await self.form_entry_channel.send(
            embed=self.Question_Embed(author, self.users[author.id]["Question"], message, footer))
    ...
    async def request_message(self, author: discord.User, message, footer):
        ...
        reply = await self.form_entry_channel.send(
            embed=self.Question_Embed(author, self.users[author.id]["Question"], message, footer))
    ...
    async def wait_for_message(self, author: discord.User):
        ...
        try:
            ...
            while len(response.content) > character_limit:
                await self.form_entry_channel.send(
                    f'Sorry, we only allow responses with less than {character_limit} characters! Please try again.')
                try:
                    response = await self.bot.wait_for('message', check=message_check, timeout=self.timeout)
